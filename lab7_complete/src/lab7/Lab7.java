...
public class Lab7 {
    ...
    private void runAnalysis(){
        ...
        //Below are the Homework assignment
        System.out.println("-------Homework--------");
        System.out.println("findAverageLikesPerComment");
        helper.findAverageLikesPerComment();

        helper.getPostWithMostLikes();  

        System.out.println("getPostWithMostLikes");
        helper.getPostWithMostLikes();
        System.out.println("PostWithMostComments");

        helper.getPostWithMostComments();
        System.out.println("FiveMostInactiveUserByPostsCount");
        helper.getFiveMostInactiveUserByPostsCount();
        System.out.println("FiveMostInactiveUserByCommentsCreated");
        helper.getFiveMostInactiveUserByCommentsCreated();
        System.out.println("FiveMostInactiveUserOverall");
        helper.getFiveMostInactiveUserOverall();
        System.out.println("FiveMostProactiveUserOverall");
        helper.getFiveMostProactiveUserOverall();
    }
