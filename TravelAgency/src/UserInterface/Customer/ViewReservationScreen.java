 ...
 */
public class ViewReservationScreen extends javax.swing.JPanel {
     ...
     */
    public ViewReservationScreen(JPanel rightPanel, TravelAgency agency, Customer cust) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tabProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight Number", "Date", "Departure Time", "Arrival Time", "FromTo", "Seat"
            }
        ) {
        ...
        lblTitle.setText("View Reserved Flights");
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        layout.show(this.rightPanel, "CustomerMain");
    ...
    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            this.cust.getReservedList().remove(info);
    ...
    private void btnChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeActionPerformed
        ...
        if (selectedRow >= 0) {
            Reservation info = (Reservation) tabProducts.getValueAt(selectedRow, 0);
            Flight f=this.agency.searchFlightByNum(info.getFlightNo());
            UpdateReservationScreen view=new UpdateReservationScreen(this.rightPanel,this.agency,f,info,this.cust,"ViewReservationScreen");
    ...
    public void populate() {
        ...
        dtm.setRowCount(0);
        for (Reservation res : cust.getReservedList()) {
