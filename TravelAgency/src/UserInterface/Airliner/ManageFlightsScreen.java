 ...
 */
public class ManageFlightsScreen extends javax.swing.JPanel {

    private JPanel rightPanel;
    private TravelAgency agency;
    private int index;//选中的airline
    /**
     * Creates new form AgentMainScreen
     */
    public ManageFlightsScreen(JPanel rightPanel,TravelAgency agency,int index) {
        initComponents();
        this.rightPanel=rightPanel;
        this.agency=agency;
        this.index=index;
        this.lblTitle.setText("Manage Flights of "+agency.getAirlinerDir().getAirlinerList().get(index).getAirlinerName());
    ...
    private void initComponents() {
        ...
        tabProducts.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Flight Number", "Date", "Departure Time", "Arrival Time", "FromTo"
            }
        ) {
        ...
        lblTitle.setText("Manage Flights of");

        btnAdd.setText("Create Flight");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        CreateFlightScreen view=new CreateFlightScreen(this.rightPanel,this.agency,index);
        this.rightPanel.add("CreateFlightScreen",view);
        CardLayout layout=(CardLayout)this.rightPanel.getLayout();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            this.agency.getAirlinerDir().getAirlinerList().get(index).getSchedule().getFlights().remove(info);
    ...
    public void populate()
    {
        ...
        dtm.setRowCount(0);
        for (Flight i : agency.getAirlinerDir().getAirlinerList().get(index).getSchedule().getFlights()) {
