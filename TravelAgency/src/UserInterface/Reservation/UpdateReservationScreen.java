 ...
 */
public class UpdateReservationScreen extends javax.swing.JPanel {

    private JPanel rightPanel;
    private TravelAgency agency;
    private Reservation resv;
    private Customer origCust;
     ...
     */
    public UpdateReservationScreen(JPanel rightPanel, TravelAgency agency, Flight flight,Reservation resv,Customer cust,String sourcePanel) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Change reservation");
    ...
    private void initialize() {
        ...
        if (seats.length > 0) {
            ...
            boxRow.setSelectedItem(this.resv.getRow());
    ...
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        ...
        for (Component comp : comps) {
            if (comp instanceof ViewReservationScreen) {
                ViewReservationScreen manageP = (ViewReservationScreen) comp;
                manageP.populate();
            }
            if (comp instanceof ViewAllReservationScreen) {
                ViewAllReservationScreen manageP = (ViewAllReservationScreen) comp;
                manageP.populate();
            }
        }
        layout.show(rightPanel, this.sourcePanel);
    }//GEN-LAST:event_btnBackActionPerformed

    private void btnChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChangeActionPerformed
        // TODO add your handling code here:
        //删除原注册信息
        this.origCust.removeReservation(resv);
        this.selectedFlight.cancelBook(this.resv.getRow(), this.resv.getCol());
        ...
        if (cust.reservedThisFlight(res)) {
            ...
            if (bookRes) {
                ...
                JOptionPane.showMessageDialog(null, "Update Reservation succussfully!");
            } else {
